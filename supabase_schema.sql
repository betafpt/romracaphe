...
-- 9. Create Bot Commands Table (Chạy lệnh này để đồng bộ Realtime điều khiển Grab Bot)
...
-- Kích hoạt Realtime cho bảng bot_commands
ALTER TABLE public.bot_commands REPLICA IDENTITY FULL;
-- Chạy lệnh dưới đây nếu bảng chưa nằm trong publication realtime
